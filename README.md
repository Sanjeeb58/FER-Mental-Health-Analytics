...
\* `FER2013\_processed/`: (Ignored in repo) The pre-processed image dataset.

\* `run\_webcam.bat`: A one-click script to launch the application.
...
&nbsp;   You can simply double-click the \*\*`run\_webcam.bat`\*\* file, or run:
